...
export function createWelcomeFolder(dispatch: ActionDispatcher) {
  ...
  items.push(
    createNewFolderItem(
      "https://www.youtube.com/watch?v=kxb0zG4a5MM",
      "Watch key features overview",
      "https://www.gstatic.com/youtube/img/creator/favicon/favicon_32_v2.png"
    )
  );
  items.push(
    createNewFolderItem(
      "https://www.youtube.com/watch?v=9jZCsg8lF8o",
