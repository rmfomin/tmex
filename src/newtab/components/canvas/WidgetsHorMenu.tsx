...
export function WidgetsHorMenu(p: {
  ...
  const selectedWidgets = p.widgets.filter((w) =>
    p.selectedWidgetIds.includes(w.id)
  );
  ...
  return (
    <div ref={widgetsMenuRef} className="widgets-hor-menu">
      <button
        className="widget-menu-item sticker-color"
        onClick={onChangeColor}
        title="Change color"
      >
        <div
          className="sticker-color__inner"
          style={{ background: currentColor }}
        ></div>
      </button>
      <button
        className="widget-menu-item sticker-size"
      ...
      <button
        className={CL("widget-menu-item sticker-strike", {
