...
//         <p>
//           Are you sure you want to leave the <b>Tabme Beta Program</b>? If you
//           proceed:
//         </p>
//         <ul>
...
//         </ul>
//         <p>You can rejoin the Beta later.</p>

//         <button className="btn__setting" onClick={leaveTheBeta}>
//           Merge Spaces and leave the Beta Program
//         </button>
//       </div>
//     </Modal>
//   );
